...
const GitHubViewer = ({ isOpen, onClose }: GitHubViewerProps) => {
  ...
  return (
    <DraggableWindow
      title={showStructure ? selectedProject?.title || 'Mes réalisations' : 'Mes réalisations'}
      onClose={onClose}
      initialPosition={{ 
    ...
    >
      <div className="overflow-y-auto p-4 md:p-6" style={{ maxHeight: 'calc(90vh - 1.5rem)' }}>
        {!showStructure ? (
          <>
            <h2 className="text-2xl font-bold mb-4 text-gray-200">Mes projets principaux</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {selectedProject && selectedProject.structure && (
              <div className="bg-gray-800/50 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-4 text-gray-200">Structure du projet</h3>
              ...
              {selectedProject && selectedProject.phrase && (
              <div className="bg-gray-800/50 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-4 text-gray-200">Description du projet</h3>
                <div className="font-mono text-sm">
                  <p className="text-gray-400 mb-2">{selectedProject.phrase}</p>
                </div>
              </div>
              )}
              ...
              {selectedProject && selectedProject.images && selectedProject.images.length > 0 && (
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <h3 className="text-xl font-semibold mb-4 text-gray-200">Capture d'écran</h3>
                  ...
                  {selectedProject.repoUrl && (
                    <div className="mt-4">
                      ...
                      >
                        <FaGithub />
                        <span>Visiter le repository Github</span>
                      </a>
                    </div>
                  )}
