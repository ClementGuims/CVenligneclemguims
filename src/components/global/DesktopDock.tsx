...
import { BsGithub, BsSpotify, BsFilePdf, BsStickyFill, BsLinkedin, BsCalendar, BsLaptop } from 'react-icons/bs';
          ...
          <div className="flex space-x-2">
            ...
            >
              <div className={`w-12 h-12 bg-gradient-to-t from-black to-black/60 rounded-xl flex items-center justify-center shadow-lg transition-all duration-300 ease-out hover:scale-110 active:scale-95 ${activeApps.github ? 'ring-2 ring-white/50' : ''}`}>
                <BsLaptop size={35} className='text-gray-100' />
              </div>
              {hoveredIcon === 'github' && <Tooltip text='Mes réalisations' />}
            </button>
            ...
            >
              ...
              {hoveredIcon === 'notes' && <Tooltip text='Notes' />}
            </button>
            ...
            >
              ...
              {hoveredIcon === 'resume' && <Tooltip text='Afficher CV' />}
            </button>
            ...
            >
              ...
              {hoveredIcon === 'calendar' && <Tooltip text='Planifier un appel' />}
            </button>
            ...
            >
              ...
              {hoveredIcon === 'spotify' && <Tooltip text='Playlist Spotify' />}
            </button>
            ...
            >
              ...
              {hoveredIcon === 'links' && <Tooltip text='Liens de contact' />}
