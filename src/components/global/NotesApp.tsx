...
const NotesApp = ({ isOpen, onClose }: NotesAppProps) => {
    ...
    const renderExtraCurricularActivities = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Autres activités</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                    ...
                    <p className="text-gray-400">Voir mon parcours et mes qualifications</p>
                </div>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Expériences professionnelles</h3>
                    </div>
                    <p className="text-gray-400">Découvrez mon expérience professionnelle</p>
                </div>
                ...
                >
                    ...
                    <p className="text-gray-400">Voir mes compétences techniques et mon expertise</p>
                </div>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Autres activités</h3>
                    </div>
                    <p className="text-gray-400">Découvrez mes activités hors professionnelles</p>
                </div>
    ...
    const getWindowTitle = () => {
        switch (activeSection) {
            ...
            case 'education': return 'Notes - Education';
            case 'experience': return 'Notes - Experiences profesionnelles';
            case 'skills': return 'Notes - Compétences';
            // case 'roles': return 'Notes Travail périscolaire';
            case 'activities': return 'Notes - Autres Activités';
